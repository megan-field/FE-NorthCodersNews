      ...
      return (
        <div className="pageContainer">
                            ...
                            return (
                              <div>
                                <div key={i} className='commentDiv'>
                                  ...
                                  <Link to={`/users/${comment.created_by}`}><p><i className="fas fa-user"></i> Created by: {comment.created_by}</p></Link>
          ...
          <div className="buttons">
            <Button id="left" type="submit" value="previous" onClick={this.fetchNextComments} disabled={this.state.current < 2 ? true : false}><i className="fas fa-arrow-alt-circle-left" /></Button>
            <Button type="submit" value="next" onClick={this.fetchNextComments} disabled={this.state.comments.length < 5 ? true : false}><i className="fas fa-arrow-alt-circle-right" /></Button>
          </div>
        </div>
      );
    }
